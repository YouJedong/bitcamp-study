...
INSERT INTO `location` (`lno`, `rno`, `sno`) VALUES (14, 9, 5);
INSERT INTO `location` (`lno`, `rno`, `sno`) VALUES (15, 10, 10);
...
INSERT INTO `board` (`bno`, `cateno`, `mno`, `title`, `act`, `cont`, `cdt`, `vw_cnt`) VALUES (12, 1, 6, '요즘 부트캠프들 제대로 교육안해서 난리네요 ', 1,'이번에 부트캠프 모업체에서 교육생이 제대로 안가르쳐서 후불제 교육비 못내겠다고 했더니 소송걸렸다고 하네요. 이번 기회에 코딩 교육기관들 정화되길 기대해 봅니다.', '2022-10-16 13:34:02', 0);
...
INSERT INTO `board` (`bno`, `cateno`, `mno`, `title`, `act`, `cont`, `cdt`, `vw_cnt`) VALUES (15, 1, 4, '죄송한데 핸드북이 뭔가요?', 1,'이번에 자바의정석을 사면서 첫장에 공부하는 법이라는 부분에서 핸드북을 참고 하시고 진행해 나가면 된다고 되어있어서요 혹시 기초편에 붙어있는 그 크고 두꺼운책인가요?', '2022-10-16 13:36:18', 0);
...
INSERT INTO `board` (`bno`, `cateno`, `mno`, `title`, `act`, `cont`, `cdt`, `vw_cnt`) VALUES (18, 1, 1, 'Ebook 어디꺼 사용하시나요? ', 1,'안녕하세요 혹시 탭이나 모바일로 개발 서적을 보고 싶은데 어디를 선택해야 하는지 모르겠어서요', '2022-10-16 13:37:44', 0);
INSERT INTO `board` (`bno`, `cateno`, `mno`, `title`, `act`, `cont`, `cdt`, `vw_cnt`) VALUES (19, 1, 6, '혹시 이거 해킹당한건가요? ', 1,'휴대폰 구글원격 프로그램으로 컴퓨터 확인하는 도중 갑자기 파일들 삭제되고 그러길래 컴퓨터 황급히 끄고 집에 와서 확인해보니 동영상처럼 마구잡이로 키보드가 저럽니다... 키보드를 빼면 괜찮구요 ', '2022-10-16 13:38:12', 0);
INSERT INTO `board` (`bno`, `cateno`, `mno`, `title`, `act`, `cont`, `cdt`, `vw_cnt`) VALUES (20, 1, 7, '오늘은 즐거운 일요일', 1,'뿌시러 갑니다', '2022-10-16 13:40:28', 0);
INSERT INTO `board` (`bno`, `cateno`, `mno`, `title`, `act`, `cont`, `cdt`, `vw_cnt`) VALUES (21, 1, 9, '스벅에서 커피 한잔', 1,'여유롭네요', '2022-10-16 13:40:53', 0);
INSERT INTO `board` (`bno`, `cateno`, `mno`, `title`, `act`, `cont`, `cdt`, `vw_cnt`) VALUES (22, 1, 10, '나는 장슬기', 1,'거꾸로하면 기슬장', '2022-10-16 13:41:10', 0);
...
INSERT INTO `board` (`bno`, `cateno`, `mno`, `title`, `act`, `cont`, `cdt`, `vw_cnt`) VALUES (26, 2, 8, '질문\r\n다이어트식단\r\n', 1,'다이어트 식단 고민인데 아침 사과 저녁 자유식(600칼로리 밑) 저녁 단백질쉐이크 or 닭가슴살 이러면 10키로 빼는데 얼마걸리나요 ', '2022-10-16 13:44:16', 0);
...
INSERT INTO `board` (`bno`, `cateno`, `mno`, `title`, `act`, `cont`, `cdt`, `vw_cnt`) VALUES (28, 2, 7, '남자 다이어트 식단 ', 1,'남자22살 키167 몸무게 65.6입니다 이렇게 다이어트 식단을 짤려고하는데 괜찮을까요?  아침 샐러드,닭가슴살,구운계란 점심 다이어트 도시락1 바나나1 아몬드10알 저녁 운동후 단백질쉐이크1 바나나1 아몬드10알 ', '2022-10-16 13:45:23', 0);
...
INSERT INTO `board` (`bno`, `cateno`, `mno`, `title`, `act`, `cont`, `cdt`, `vw_cnt`) VALUES (30, 2, 6, '다이어트 식단', 1,'저 중2인데요 ㅠㅠ 다이어트 식단으로 아침에는 바나나 먹고 점심에는 그냥 급식 먹고 저녁에는 닭가슴살100g에 고구마 2개 먹고 운동으론 계단 오르기 15층 까지 할 예정인데,, 뺄 수있을 까요?? 그리고 추천하는 운동 몇가지 답변 부탁 드려요 ㅠㅠ', '2022-10-16 13:46:27', 0);
...
INSERT INTO `board` (`bno`, `cateno`, `mno`, `title`, `act`, `cont`, `cdt`, `vw_cnt`) VALUES (32, 2, 1, '다이어트 식단', 1,'다이어트 식단 좀 봐주세요 일단 6시에 집나가서 대략 밤10~11시에 퇴근하는 여자입니다 이 일을 시작하고나서는 야식으로 폭식하고 끼니는 제대로 못먹었습니다.. 거의 온종일 앉아만있고 움직이는거라곤 출퇴근할때 걷는게 다 입니다,,,   살은 빼야하는데ㅠㅠ 11월까지 많은 지방들과 인사해야해서 식단 도와주세요ㅜㅜ', '2022-10-16 13:47:38', 0);
INSERT INTO `board` (`bno`, `cateno`, `mno`, `title`, `act`, `cont`, `cdt`, `vw_cnt`) VALUES (33, 2, 3, '다이어트식단 짜주세요 ', 1,'여자/ 단기간 10키로 감량 목표입니다ㅜㅜ 아오리사과, 방울토마토, 바나나, 계란으로 다이어트 식단 짜주시면 감사하겠습니다 !!', '2022-10-16 13:48:02', 0);
...
INSERT INTO `board` (`bno`, `cateno`, `mno`, `title`, `act`, `cont`, `cdt`, `vw_cnt`) VALUES (36, 3, 6, '고강도다이어트짐(만수동헬스장 만수동헬스) 다이어트 챌린지 성공', 1,'제가 운동하는 곳에는 여러 종류의 다이어트 챌린지들이 있어요. 10kg 20kg 30kg 다이어트 등 감량하는 무게에 따라 리워드가 있기도 하고 첫 달에 다이어트하는 양에 따라 또 리워드가 있기도 해요.  그 외에도 운동, 식단 챌린지 등 운동과 다이어트를 자극할 수 있는 것들이 많이 있습니다. 전 여러 가지 중에서 12월 말부터 1월에 걸쳐서 4주 동안 멱살 챌린지라는 다이어트 챌린지를 했어요. 팀을 짜서 팀원이 다 같이 목표한 만큼 감량해야 하는 챌린지인데 저희 팀은 6명이서 총 24.7kg 뺐어요. 1인당 4kg이니까 매주 1kg. 적지 않죠. 성공했습니다. 그래서 고다짐에서 쓸 수 있는 상금을 1인당 60만 원 총 360만 원을 받았어요.', '2022-10-16 13:51:32', 0);
INSERT INTO `board` (`bno`, `cateno`, `mno`, `title`, `act`, `cont`, `cdt`, `vw_cnt`) VALUES (37, 3, 3, '[다이어트] 여자 바디프로필 준비기간과 과정/ 식단/ 태닝/ 수분조절/ 10주간 -9kg 감량 후기', 1,'지난번 바디프로필 촬영후기에 이어 다이어트 과정을 남겨보려해요 스스로 추억할겸 참고할 남기는 후기 !', '2022-10-16 13:54:08', 0);
...
INSERT INTO `board` (`bno`, `cateno`, `mno`, `title`, `act`, `cont`, `cdt`, `vw_cnt`) VALUES (42, 3, 7, '다이어트 챌린지 어플로 만보 걷기 성공', 1,'나이키 런 보다 괜찮은 것 같아요 (광고 아님)', '2022-10-16 13:58:53', 0);
...
INSERT INTO `board` (`bno`, `cateno`, `mno`, `title`, `act`, `cont`, `cdt`, `vw_cnt`) VALUES (52, 4, 6, '구로구에 괜찮은 헬스장 추천 좀 해주세요', 1,'머리 빈 트레이너 말고 전문 지식 가지고 있는 분 원합니다', '2022-10-16 14:04:31', 0);
INSERT INTO `board` (`bno`, `cateno`, `mno`, `title`, `act`, `cont`, `cdt`, `vw_cnt`) VALUES (53, 4, 7, '운동복 어디서 구매하시나요?', 1,'[ㅅ진] 키 180, 몸무게 80 추천해주십시오', '2022-10-16 14:05:04', 0);
...
INSERT INTO `board` (`bno`, `cateno`, `mno`, `title`, `act`, `cont`, `cdt`, `vw_cnt`) VALUES (59, 5, 7, '[홈플러스] 미국산 초이스 냉장소찜갈비 100g (2,040원) ', 1,'10개 단위로 구매 가능 농협 롯데카드 있으면 홈플페이 카드등록하고 8만이상 7프로 추가할인 유튜브에 백종원소갈비찜 검색해서 따라해봐 개꿀맛', '2022-10-16 14:09:25', 0);
...
INSERT INTO `board` (`bno`, `cateno`, `mno`, `title`, `act`, `cont`, `cdt`, `vw_cnt`) VALUES (62, 5, 6, '[쿠팡] 미주라 요거트비스켓 400g x 2개 (5,560원) (와우회원무료)', 1,'이번에 처음 시켜보는거라 맛은 몰라요', '2022-10-16 14:10:41', 0);
