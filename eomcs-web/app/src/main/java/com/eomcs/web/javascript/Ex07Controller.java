...
public class Ex07Controller {
  ...
  public Ex07Controller(RestTemplateBuilder restRemplateBuilder) {
    restTemplate = restRemplateBuilder.build();
  }
  ...
  public String test2(HttpServletResponse response) throws Exception {
    // 모든 클라리언트에 대해
    // 이 URL의 AJAX 요청을 허락한다는 의미 이다.
    response.setHeader("Access-Control-Allow-Origin"  , "*");
    // HttpServletResponse를 사용한다면 view URL을 명시적으로 지정해야한다.
