package com.bitcamp.board0722.dao;

import com.bitcamp.board0722.domain.Board;
...
public class BoardList extends ObjectList {
  ...
  public Board get(int boardNo) {
    ...
    for (int i = 0; i < this.length; i++) {
      // Object배열에 실제로 들어있는 것은 Board라고 컴파일러에게 알린다.
  ...
  // 수퍼 클래스의 add()를 BoardList에 맞게 재정의 한다.
  ...
  // 수퍼 클래스의 remove()를 BoardList 클래스의 역할에 맞춰 재정의 한다.
  @Override
