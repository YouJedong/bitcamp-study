...
public class BoardHandler6 {
  ...
  static void processDetail() {
    ...
    int boardNo = Prompt6.inputInt("조회할 게시글 번호? ");
  ...
  static void processInput() {
    ...
    title[boardCount] = Prompt6.inputString("제목?");
    content[boardCount] = Prompt6.inputString("내용?");
    writer[boardCount] = Prompt6.inputString("작성자?");
    password[boardCount] = Prompt6.inputString("암호?");
