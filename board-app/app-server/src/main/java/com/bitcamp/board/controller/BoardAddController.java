...
public class BoardAddController extends HttpServlet {
  ...
  protected void doPost(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      // multipart/form-data 형식으로 요청한 데이터에 대해서는
